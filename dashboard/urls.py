...
urlpatterns = [
    ...
    path('admin-reset-password/<int:id>/',views.user_send_set_password,name='AdminForgetPassword'),
    path('user-set-password/<uidb64>/<token>/',views.UserSetPasswordView.as_view(),name='UserSetPassword'),
    ...
    path('edit-userdata/<int:id>/',views.EditUserDetailsView.as_view(),name='EditUserDetails'),
