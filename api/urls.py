...
urlpatterns = [
    ...
    path('show-tiket-chat-count/',views.TicketChatNumberView.as_view(),name='TicketChatNumber'),
    ...
    path('salesgraph-evolution-sales-data/',views.SalesGraphEvolutionSalesDataView.as_view(),name='SalesGraphTotalSalesData'),
    ...
    path('customergraph-customerevolution/',views.CustomerGraphByCustomerEvolutionTodayView.as_view(),name='CustomerGraphByCustomerEvolutionTodayView'),
